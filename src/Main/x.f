...
*
      ...
      LOGICAL ipredall
*
      print*,' 1 jpred i=',i,(x(k,i),k=1,3),(xdot(k,i),k=1,3)
      print*,' 1 jpred 108 ',(x(k,108),k=1,3),(xdot(k,108),k=1,3)
...
*     Distinguish between low and high-order prediction of U & UDOT.
      ...
      print*,' 2 jpred 108 ',(x(k,108),k=1,3),(xdot(k,108),k=1,3)
      print*,' 2 jpred i=',i,(x(k,i),k=1,3),(xdot(k,i),k=1,3)
