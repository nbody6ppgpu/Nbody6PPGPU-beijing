...
* A. Tanikawa adds 27.09.2021 - Kamlah 28.09.2021 - A. Taniakwa comments out 15.10.2022
!         if(askInUseOrNot() .and. askInScopeOfApplication(m0)) then
...
* Helium core mass is less then the BAGB minimum.
            ...
            CALL star(kw,m0,mt,tm,tn,tscls,lums,GB,zpars)
            aj = tscls(2) + tscls(3) + 2.d0*tiny  !Kamlah 28.09.2021
         endif
      endif
*
*
...
*
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
* A. Tanikawa adds 27.09.2021 - Kamlah 28.09.2021 - A. Tanikawa comments out 15.10.2022
