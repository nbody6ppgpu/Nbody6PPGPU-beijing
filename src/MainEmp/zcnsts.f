...
* Tanikawa adds here 15.10.2022
      logical usebseemp
      parameter (usebseemp=.true.)
*
*
*
*       ------------------------------------------------------------
...
*
* Tanikawa's prescription
* Tanikawa changes here 15.10.2022
*      if(z .lt. 0.0001) then
...
*!        z = 0.0001220703125
*      endif
      if(usebseemp .and. z.le.0.002) then
         zeta = log10(z/0.02)
         if(z.lt.0.0001 .or. (0.00019.lt.z .and. z.lt.0.00021)
