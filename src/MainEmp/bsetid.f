...
*
      ...
      real*8 sep,ecc,oorb,delet1,dspin,eqspin,djt,rconv
      real*8 renvk,rg2,k3
      PARAMETER(K3=0.21D0)
      real*8 ecc2,omecc2,sqome2,sqome3,raa2,raa6,twopi
      real*8 f1,f2,f3,f4,f5,tc,fc,tcqr,ttid
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
* Kamlah 16.09.2021 - Kinugawa et al. (2020) radiative tidal damping
	  logical NewDynTide
	  parameter (NewDynTide=.false.)
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC	  
*
* Tanikawa's prescription
...
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
* Kamlah 16.09.2021 - Kinugawa et al. (2020) radiative tidal damping
* Taken from Tanikawa BSE
          if(.not. NewDynTide)then
              tc = 1.592d-09*(mass**2.84d0)
          else
             if(kw.lt.7)then
               rconv = 
     &                 getConvectiveCoreRadiusOfBluePhase
     &                 (mass)
               tc = 10**(-0.42)*(rconv/r)**7.5
             else
               tc = 10**(-0.93)*(0.5/r)**6.7
             endif
         endif
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
