...
*       Obtain the tidal energy change for GR.
          CALL TIDES3_QPMOD(QPERI,M(K1),M(K2),VSTAR1,H,ECC,DE)
...
*
      END
*       This subroutine only here for qpmod; it has been changed for other use (RSp Dec 2020).
      SUBROUTINE TIDES3_QPMOD(QPERI,M1,M2,VSTAR,HI,ECC,DE)
*
*
