...
*
* Tanikawa's prescription
      if(askInUseOrNot() .and. askInScopeOfApplication(m)) then
         lzamsf = 10**(getLuminosityZAMSTime(m))
      end if
*
      return
      end
...
* Tanikawa's prescription
      if(askInUseOrNot() .and. askInScopeOfApplication(m)) then
         thookf = getRatioOfTMSTimeToHeITime(m)
      end if
*
      return
      end
...
* Tanikawa's prescription
      if(askInUseOrNot() .and. askInScopeOfApplication(m)) then
         ltmsf = 10**(getLuminosityTMSTime(m))
      end if
*
      return
      end
...
* Tanikawa's prescription
      if(askInUseOrNot() .and. askInScopeOfApplication(m)) then
         lalphf = getAlphaOfLuminosityMSPhase(m)
      end if
*
      return
      end
...
* Tanikawa's prescription
      if(askInUseOrNot() .and. askInScopeOfApplication(m)) then
         lbetaf = getBetaOfLuminosityMSPhase(m)
      end if
*
      return
      end
...
* Tanikawa's prescription
      if(askInUseOrNot() .and. askInScopeOfApplication(m)) then
         lhookf = getDifferentialLuminosityOfHook(m)
      end if
*
      return
      end
...
* Tanikawa's prescription
      if(askInUseOrNot() .and. askInScopeOfApplication(m)) then
         ralphf = getAlphaOfRadiusMSPhase(m)
      end if
*
      return
      end
...
* Tanikawa's prescription
      if(askInUseOrNot() .and. askInScopeOfApplication(m)) then
         rbetaf = getBetaOfRadiusMSPhase(m)
      end if
*
      return
      end
...
* Tanikawa's prescription
      if(askInUseOrNot() .and. askInScopeOfApplication(m)) then
         rgammf = getGammaOfRadiusMSPhase(m)
      end if
*
      return
      end
...
* Tanikawa's prescription
      if(askInUseOrNot() .and. askInScopeOfApplication(m)) then
         rhookf = getDifferentialRadiusOfHook(m)
      end if
*
      return
      end
...
* Tanikawa's prescription
      if(askInUseOrNot() .and. askInScopeOfApplication(m)) then
         lbagbf = 10**(getLuminosityBAGBTime(m))
      end if
*
      return
      end
...
* Tanikawa's prescription
      if(askInUseOrNot() .and. askInScopeOfApplication(m)) then
         ragbf = 10**(getRadiusRedPhase(m, lum))
      end if
*
      return
      end
...
* Tanikawa's prescription
      if(askInUseOrNot() .and. askInScopeOfApplication(m)) then
         mcagbf = getHeCoreMassBAGBTime(m)
      end if
*
      return
      end
...
* Tanikawa's prescription
      if(askInUseOrNot() .and. askInScopeOfApplication(m)) then
         lHeIf = 10**(getLuminosityHeITime(m))
      end if
*
      return
      end
...
* Tanikawa's prescription
      if(askInUseOrNot() .and. askInScopeOfApplication(m)) then
         rminf = 10**(getMinimumRadiusCHeBPhase(m))
      end if
*
      return
      end
...
* Tanikawa's prescription
      if(askInUseOrNot() .and. askInScopeOfApplication(m)) then
         tHef = getTimeIntervalOfCHeBPhase(m) / getHeITime(m)
      end if
*
      return
      end
