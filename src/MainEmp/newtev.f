...
*       ------------------------------
*
* Tanikawa's prescriptions - Kamlah 16.09.2021
      use iso_c_binding
*
      INCLUDE 'common6.h'
...
* Tanikawa's prescription - Kamlah 16.09.2021
!      if(askInUseOrNot() .and. askInScopeOfApplication(m)) then
      if(askInUseOrNot() .and. askInScopeOfApplication(m0)) then ! Kamlah 28.09.2021
