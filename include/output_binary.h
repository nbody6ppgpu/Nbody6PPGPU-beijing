*     binary:
     ...
     &                  B_ASPN1(KMAX), B_ASPN2(KMAX),
     &                  B_TEV1(KMAX), B_TEV2(KMAX),
     &                  B_TEV01(KMAX), B_TEV02(KMAX),
...
*    &                  NB_NPOPU1(KMAX), NB_NPOPU2(KMAX),
     ...
     &                  B_FDR1(KMAX), B_FDR2(KMAX), B_FDR3(KMAX),
     &                  B_D21R(KMAX), B_D22R(KMAX), B_D23R(KMAX),
     &                  B_D31R(KMAX), B_D32R(KMAX), B_D33R(KMAX),
